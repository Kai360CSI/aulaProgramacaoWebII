document.addEventListener('DOMContentLoaded', () =>{
    ...
    const exibirVoluntarios = () =>{
        ...
        const tableContainer = document.getElementById('tabelaVoluntarios');

        if(!tableContainer) return;

        if(voluntarios.length == 0){
            tableContainer.innerHTML = '<p>Ninguém Cadastrado ainda.</p>';
            return;
        }

        let html = '<table border="1" cellpadding="5" cellpadding="0">';
        html += '<tr><th>Nome</th></tr><tr><th>Email</th></tr><th>Telefone</th></tr><th>Disponibilidade</th></tr>';
